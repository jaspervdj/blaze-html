...
benchmarkserver:
	ghc --make -threaded -O2 -fforce-recomp -isrc -idoc/examples -ibenchmarks -main-is BenchmarkServer doc/examples/BenchmarkServer.lhs

snapbenchmarkserver:
	ghc --make -threaded -O2 -fforce-recomp -isrc -idoc/examples -ibenchmarks -main-is SnapBenchmarkServer doc/examples/SnapBenchmarkServer.hs
