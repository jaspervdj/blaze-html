...
module Text.Blaze.Html4.FrameSet.Attributes                                     -- util/GenerateHtmlVariant.hs:121
    ...
    , accept_charset                                                            -- util/GenerateHtmlVariant.hs:124
    , accesskey                                                                 -- util/GenerateHtmlVariant.hs:124
    , align                                                                     -- util/GenerateHtmlVariant.hs:124
    , alink                                                                     -- util/GenerateHtmlVariant.hs:124
    , alt                                                                       -- util/GenerateHtmlVariant.hs:124
    , axis                                                                      -- util/GenerateHtmlVariant.hs:124
    , background                                                                -- util/GenerateHtmlVariant.hs:124
    , bgcolor                                                                   -- util/GenerateHtmlVariant.hs:124
    ...
    , color                                                                     -- util/GenerateHtmlVariant.hs:124
    , cols                                                                      -- util/GenerateHtmlVariant.hs:124
    , colspan                                                                   -- util/GenerateHtmlVariant.hs:124
    , compact                                                                   -- util/GenerateHtmlVariant.hs:124
    ...
    , face                                                                      -- util/GenerateHtmlVariant.hs:124
    ...
    , hspace                                                                    -- util/GenerateHtmlVariant.hs:124
    ...
    , longdesc                                                                  -- util/GenerateHtmlVariant.hs:124
    , marginheight                                                              -- util/GenerateHtmlVariant.hs:124
    , marginwidth                                                               -- util/GenerateHtmlVariant.hs:124
    ...
    , noresize                                                                  -- util/GenerateHtmlVariant.hs:124
    , noshade                                                                   -- util/GenerateHtmlVariant.hs:124
    , nowrap                                                                    -- util/GenerateHtmlVariant.hs:124
    ...
    , vlink                                                                     -- util/GenerateHtmlVariant.hs:124
    , vspace                                                                    -- util/GenerateHtmlVariant.hs:124
...
-- | Combinator for the @alink@ attribute.
--
-- Example:
--
-- > div ! alink "bar" $ "Hello."
...
-- Result:
--
-- > <div alink="bar">Hello.</div>
--
alink :: AttributeValue  -- ^ Attribute value.                                  -- util/GenerateHtmlVariant.hs:248
      -> Attribute       -- ^ Resulting attribute.                              -- util/GenerateHtmlVariant.hs:249
alink = attribute " alink=\""                                                   -- util/GenerateHtmlVariant.hs:250
{-# INLINE alink #-}                                                            -- util/GenerateHtmlVariant.hs:251
...
--
background :: AttributeValue  -- ^ Attribute value.                             -- util/GenerateHtmlVariant.hs:248
           -> Attribute       -- ^ Resulting attribute.                         -- util/GenerateHtmlVariant.hs:249
background = attribute " background=\""                                         -- util/GenerateHtmlVariant.hs:250
{-# INLINE background #-}                                                       -- util/GenerateHtmlVariant.hs:251
...
--
bgcolor :: AttributeValue  -- ^ Attribute value.                                -- util/GenerateHtmlVariant.hs:248
        -> Attribute       -- ^ Resulting attribute.                            -- util/GenerateHtmlVariant.hs:249
bgcolor = attribute " bgcolor=\""                                               -- util/GenerateHtmlVariant.hs:250
{-# INLINE bgcolor #-}                                                          -- util/GenerateHtmlVariant.hs:251
...
-- Result:
--
-- > <div color="bar">Hello.</div>
--
color :: AttributeValue  -- ^ Attribute value.                                  -- util/GenerateHtmlVariant.hs:248
      -> Attribute       -- ^ Resulting attribute.                              -- util/GenerateHtmlVariant.hs:249
color = attribute " color=\""                                                   -- util/GenerateHtmlVariant.hs:250
{-# INLINE color #-}                                                            -- util/GenerateHtmlVariant.hs:251
...
--
compact :: AttributeValue  -- ^ Attribute value.                                -- util/GenerateHtmlVariant.hs:248
        -> Attribute       -- ^ Resulting attribute.                            -- util/GenerateHtmlVariant.hs:249
compact = attribute " compact=\""                                               -- util/GenerateHtmlVariant.hs:250
{-# INLINE compact #-}                                                          -- util/GenerateHtmlVariant.hs:251
...
-- | Combinator for the @face@ attribute.
--
-- Example:
--
-- > div ! face "bar" $ "Hello."
...
-- Result:
--
-- > <div face="bar">Hello.</div>
--
face :: AttributeValue  -- ^ Attribute value.                                   -- util/GenerateHtmlVariant.hs:248
     -> Attribute       -- ^ Resulting attribute.                               -- util/GenerateHtmlVariant.hs:249
face = attribute " face=\""                                                     -- util/GenerateHtmlVariant.hs:250
{-# INLINE face #-}                                                             -- util/GenerateHtmlVariant.hs:251
...
--
hspace :: AttributeValue  -- ^ Attribute value.                                 -- util/GenerateHtmlVariant.hs:248
       -> Attribute       -- ^ Resulting attribute.                             -- util/GenerateHtmlVariant.hs:249
hspace = attribute " hspace=\""                                                 -- util/GenerateHtmlVariant.hs:250
{-# INLINE hspace #-}                                                           -- util/GenerateHtmlVariant.hs:251
...
-- | Combinator for the @link@ attribute.
--
-- Example:
--
-- > div ! link "bar" $ "Hello."
...
-- Result:
--
-- > <div link="bar">Hello.</div>
--
link :: AttributeValue  -- ^ Attribute value.                                   -- util/GenerateHtmlVariant.hs:248
     -> Attribute       -- ^ Resulting attribute.                               -- util/GenerateHtmlVariant.hs:249
link = attribute " link=\""                                                     -- util/GenerateHtmlVariant.hs:250
{-# INLINE link #-}                                                             -- util/GenerateHtmlVariant.hs:251

-- | Combinator for the @longdesc@ attribute.
--
-- Example:
--
-- > div ! longdesc "bar" $ "Hello."
--
-- Result:
--
-- > <div longdesc="bar">Hello.</div>
--
longdesc :: AttributeValue  -- ^ Attribute value.                               -- util/GenerateHtmlVariant.hs:248
         -> Attribute       -- ^ Resulting attribute.                           -- util/GenerateHtmlVariant.hs:249
longdesc = attribute " longdesc=\""                                             -- util/GenerateHtmlVariant.hs:250
{-# INLINE longdesc #-}                                                         -- util/GenerateHtmlVariant.hs:251
...
--
marginheight :: AttributeValue  -- ^ Attribute value.                           -- util/GenerateHtmlVariant.hs:248
             -> Attribute       -- ^ Resulting attribute.                       -- util/GenerateHtmlVariant.hs:249
marginheight = attribute " marginheight=\""                                     -- util/GenerateHtmlVariant.hs:250
{-# INLINE marginheight #-}                                                     -- util/GenerateHtmlVariant.hs:251
...
--
marginwidth :: AttributeValue  -- ^ Attribute value.                            -- util/GenerateHtmlVariant.hs:248
            -> Attribute       -- ^ Resulting attribute.                        -- util/GenerateHtmlVariant.hs:249
marginwidth = attribute " marginwidth=\""                                       -- util/GenerateHtmlVariant.hs:250
{-# INLINE marginwidth #-}                                                      -- util/GenerateHtmlVariant.hs:251
...
-- | Combinator for the @noresize@ attribute.
--
-- Example:
--
-- > div ! noresize "bar" $ "Hello."
--
-- Result:
--
-- > <div noresize="bar">Hello.</div>
--
noresize :: AttributeValue  -- ^ Attribute value.                               -- util/GenerateHtmlVariant.hs:248
         -> Attribute       -- ^ Resulting attribute.                           -- util/GenerateHtmlVariant.hs:249
noresize = attribute " noresize=\""                                             -- util/GenerateHtmlVariant.hs:250
{-# INLINE noresize #-}                                                         -- util/GenerateHtmlVariant.hs:251
...
--
noshade :: AttributeValue  -- ^ Attribute value.                                -- util/GenerateHtmlVariant.hs:248
        -> Attribute       -- ^ Resulting attribute.                            -- util/GenerateHtmlVariant.hs:249
noshade = attribute " noshade=\""                                               -- util/GenerateHtmlVariant.hs:250
{-# INLINE noshade #-}                                                          -- util/GenerateHtmlVariant.hs:251
...
--
nowrap :: AttributeValue  -- ^ Attribute value.                                 -- util/GenerateHtmlVariant.hs:248
       -> Attribute       -- ^ Resulting attribute.                             -- util/GenerateHtmlVariant.hs:249
nowrap = attribute " nowrap=\""                                                 -- util/GenerateHtmlVariant.hs:250
{-# INLINE nowrap #-}                                                           -- util/GenerateHtmlVariant.hs:251
...
-- | Combinator for the @text@ attribute.
--
-- Example:
--
-- > div ! text "bar" $ "Hello."
...
-- Result:
--
-- > <div text="bar">Hello.</div>
--
text :: AttributeValue  -- ^ Attribute value.                                   -- util/GenerateHtmlVariant.hs:248
     -> Attribute       -- ^ Resulting attribute.                               -- util/GenerateHtmlVariant.hs:249
text = attribute " text=\""                                                     -- util/GenerateHtmlVariant.hs:250
{-# INLINE text #-}                                                             -- util/GenerateHtmlVariant.hs:251
...
-- | Combinator for the @vlink@ attribute.
--
-- Example:
--
-- > div ! vlink "bar" $ "Hello."
...
-- Result:
--
-- > <div vlink="bar">Hello.</div>
--
vlink :: AttributeValue  -- ^ Attribute value.                                  -- util/GenerateHtmlVariant.hs:248
      -> Attribute       -- ^ Resulting attribute.                              -- util/GenerateHtmlVariant.hs:249
vlink = attribute " vlink=\""                                                   -- util/GenerateHtmlVariant.hs:250
{-# INLINE vlink #-}                                                            -- util/GenerateHtmlVariant.hs:251
...
--
vspace :: AttributeValue  -- ^ Attribute value.                                 -- util/GenerateHtmlVariant.hs:248
       -> Attribute       -- ^ Resulting attribute.                             -- util/GenerateHtmlVariant.hs:249
vspace = attribute " vspace=\""                                                 -- util/GenerateHtmlVariant.hs:250
{-# INLINE vspace #-}                                                           -- util/GenerateHtmlVariant.hs:251
