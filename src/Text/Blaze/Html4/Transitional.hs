...
module Text.Blaze.Html4.Transitional                                            -- util/GenerateHtmlVariant.hs:121
    ...
    , isindex                                                                   -- util/GenerateHtmlVariant.hs:124
...
--
isindex :: Html  -- ^ Inner HTML.                                               -- util/GenerateHtmlVariant.hs:182
        -> Html  -- ^ Resulting HTML.                                           -- util/GenerateHtmlVariant.hs:183
isindex = Parent "<isindex" "</isindex>"                                        -- util/GenerateHtmlVariant.hs:184
{-# INLINE isindex #-}                                                          -- util/GenerateHtmlVariant.hs:186
