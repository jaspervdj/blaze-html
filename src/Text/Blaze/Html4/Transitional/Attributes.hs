...
module Text.Blaze.Html4.Transitional.Attributes                                 -- util/GenerateHtmlVariant.hs:121
    ...
    , clear                                                                     -- util/GenerateHtmlVariant.hs:124
    ...
    , language                                                                  -- util/GenerateHtmlVariant.hs:124
...
--
clear :: AttributeValue  -- ^ Attribute value.                                  -- util/GenerateHtmlVariant.hs:248
      -> Attribute       -- ^ Resulting attribute.                              -- util/GenerateHtmlVariant.hs:249
clear = attribute " clear=\""                                                   -- util/GenerateHtmlVariant.hs:250
{-# INLINE clear #-}                                                            -- util/GenerateHtmlVariant.hs:251
...
--
language :: AttributeValue  -- ^ Attribute value.                               -- util/GenerateHtmlVariant.hs:248
         -> Attribute       -- ^ Resulting attribute.                           -- util/GenerateHtmlVariant.hs:249
language = attribute " language=\""                                             -- util/GenerateHtmlVariant.hs:250
{-# INLINE language #-}                                                         -- util/GenerateHtmlVariant.hs:251
