...
-- Example:
--
-- > text $ span $ toHtml "foo"
--
-- Result:
--
-- > <text><span>foo</span></text>
--
text :: Html  -- ^ Inner HTML.
     -> Html  -- ^ Resulting HTML.
...
-- Example:
--
-- > textpath $ span $ toHtml "foo"
--
-- Result:
--
-- > <textpath><span>foo</span></textpath>
--
textpath :: Html  -- ^ Inner HTML.
         -> Html  -- ^ Resulting HTML.
...
-- Example:
--
-- > tspan $ span $ toHtml "foo"
--
-- Result:
--
-- > <tspan><span>foo</span></tspan>
--
tspan :: Html  -- ^ Inner HTML.
      -> Html  -- ^ Resulting HTML.
